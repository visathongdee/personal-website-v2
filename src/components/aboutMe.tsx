  ...
  return (
    <section id="aboutMe" className="animate-fade-in">
      <h1 className="text-2xl/8 md:text-4xl/12">
        ...
        <span className="text-(--color-dark)">Computer Science </span>
        <span className="text-(--color-lightgrey)">from </span>
        <span className="text-(--color-dark)">Purdue University 🎓 </span>
        <span className="text-(--color-lightgrey)">
        ...
        <span className="text-(--color-dark)">Genesys Cloud ☁️ </span>
      </h1>
    </section>
  );
};
